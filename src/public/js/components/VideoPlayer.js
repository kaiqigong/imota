...
class VideoPlayer extends Component {
  ...
  constructor() {
    ...
    wx.getNetworkType({
      ...
      fail: (err) => {
        console.remote('VideoPlayer 19', err);
      },
    });
  }
  ...
  _onCanplay(e) {
    console.remote('VideoPlayer 49', e.nativeEvent, this.refs.video);
  }
  _onLoaded(e) {
    console.remote('VideoPlayer 52', e.nativeEvent, this.refs.video);
  }
